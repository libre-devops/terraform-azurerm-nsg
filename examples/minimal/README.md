...
# Minimal call: an NSG with the secure default rules, associated with the subnet.
module "nsg" {
  source = "../../"
...
| <a name="output_security_rule_ids"></a> [security\_rule\_ids](#output\_security\_rule\_ids) | The ids of the NSG rules (the effective merged set). |
